...
export const MOCK_SESSION_COOKIE = "boed_mock_user_id";
...
export const SESSION_USER_UPDATED_EVENT = "boed:session-user-updated";
...
export function getCurrentUser(
  ...
  const sessionUserId =
    window.localStorage.getItem(MOCK_SESSION_COOKIE) ??
    getCookieValue(MOCK_SESSION_COOKIE);
