...
export function FinalCTA() {
  return (
    <section className="px-6 py-24">
      <RevealWrapper className="relative mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] bg-[#0B1120] px-8 py-16 text-center sm:px-16">
        <div
          aria-hidden
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,black,transparent)]"
        />
