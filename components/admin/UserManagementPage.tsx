    ...
    <AdminLayout title="User Management">
      <div className="space-y-6 p-6">
        <section className="rounded-lg border border-border bg-card p-5">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-[1fr_160px_160px_200px_auto]">
            ...
            {canCreate && (
              <button
                onClick={openNewUser}
                className="col-span-2 flex items-center justify-center gap-2 rounded-lg bg-primary px-3 py-2.5 text-sm font-semibold text-primary-foreground lg:col-span-1"
              >
