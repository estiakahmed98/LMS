...
type Notice =
  ...
  | {
      key: "downloaded" | "revoked" | "reissued" | "revokedWithReason";
      id: string;
    };
                ...
                <button
                  onClick={() => {
                    ...
                    setRows((current) => [
                      {
                        id: nextId,
                        student: `Bulk Student ${current.length + 1}`,
                        course: "Paramedic",
                        status: "Valid",
                      },
                      ...current,
        ...
        <section className="grid gap-6 xl:grid-cols-[360px_minmax(0,1fr)]">
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              <select
                value={font}
                onChange={(event) => setFont(event.target.value as FontValue)}
                className="w-full rounded-lg border border-border bg-background px-3 py-2.5 text-sm"
              >
                <option value="Serif Formal">
                  {getFontLabel("Serif Formal")}
                </option>
                <option value="Sans Modern">
          ...
          >
            ...
            <h3 className="mt-3 text-4xl font-bold text-card-foreground">
              Fahim Ahmed
            </h3>
